    ...
    <div className="flex h-screen">
      ...
      <div className="flex-1 flex flex-col gap-5 p-8">
        ...
        <div className="installation-info flex-1 flex flex-col items-start font-bold bg-slate-200 rounded-md p-10 mx-5 h-auto">
          ...
          In C, a variable is a named memory location that is used to store a value of a certain type. The value stored in a variable can be changed during the execution of the program..{" "}
            <span className="text-blue-600 font-bold">
            To declare a variable in C, you specify its type and name. You can also initialize a variable at the same time you declare it.
            </span>
          </p>
          ...
          <ol className="inline-block font-thin text-left items-start justify-start py-1 list-decimal">
            ...
            <li className="p-5">
            A variable must be declared before it can be used. The declaration specifies the variable's name and data type.
            </li>
            <li className="p-5">
            The data type of a variable determines the kind of values it can hold and the operations that can be performed on it.  
            </li>
            <li className="p-5">
            In C, there are several data types available for variables, including int, float, double, char, and more.
            </li>
            <li className="p-5">
                Variables can be assigned new values using the assignment operators '='.
            </li>
            <li className="p-5"> 
            In C, variables can be passed as arguments to functions, returned from functions, and used in expressions.
            </li>
            <li className="p-5">
            Variables in C are case sensitive. For Example, x and X are two different variables.
            </li>
            <li className="p-5">
            Variables in C have a scope, which determines where in the program variable can be used. This scope can be local, function or global.
            </li>
            <li className="p-5">
            Variables in C can be initialized with a value when they are declared. like this,
            </li>
